...
export default function TagInput({ value, onChange, placeholder, max, id }: TagInputProps) {
  ...
  return (
    <div className="mt-1 flex flex-wrap items-center gap-2 rounded-md border border-slate-300 px-2 py-1.5 focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
      {value.map((tag) => (
        <span
          key={tag}
